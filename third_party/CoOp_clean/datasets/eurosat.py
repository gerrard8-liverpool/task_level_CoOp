    ...
    def update_classname(self, dataset_old):
        ...
        for item_old in dataset_old:
            ...
            item_new = Datum(
                ...
                classname=cname_new,
                domain=getattr(item_old, "domain", 0),
                slot_id=getattr(item_old, "slot_id", -1),
                slot_rank=getattr(item_old, "slot_rank", -1),
                dist_to_proto=getattr(item_old, "dist_to_proto", -1.0),
            )
